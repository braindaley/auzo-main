                    ...
                    <div className="space-y-3">
                        <div className="flex items-start gap-3">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-sm text-gray-900 font-medium leading-tight">{transaction.pickupLocation}</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-sm text-gray-900 font-medium leading-tight">{transaction.destination}</p>
                            </div>
                        </div>
                    </div>
                </Card>
