...
import { ArrowLeft, User, ChevronDown, Clock, MapPin, Calendar as CalendarIcon } from 'lucide-react';
            ...
            >
                <Card className="rounded-t-2xl border-none shadow-2xl">
                    <CardHeader className="pt-6 px-6 pb-4">
                         <h2 className="text-xl font-bold text-center mb-2">Plan your ride</h2>
